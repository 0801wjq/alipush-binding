...
namespace Com.Xiaomi.Push.Service.Receivers {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.xiaomi.push.service.receivers']/class[@name='NetworkStatusReceiver']"
	[global::Android.Runtime.Register ("com/xiaomi/push/service/receivers/NetworkStatusReceiver", DoNotGenerateAcw=true)]
	public partial class NetworkStatusReceiver : global::Android.Content.BroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/xiaomi/push/service/receivers/NetworkStatusReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (NetworkStatusReceiver); }
		}

		protected NetworkStatusReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.xiaomi.push.service.receivers']/class[@name='NetworkStatusReceiver']/constructor[@name='NetworkStatusReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe NetworkStatusReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (NetworkStatusReceiver)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.xiaomi.push.service.receivers']/class[@name='NetworkStatusReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
