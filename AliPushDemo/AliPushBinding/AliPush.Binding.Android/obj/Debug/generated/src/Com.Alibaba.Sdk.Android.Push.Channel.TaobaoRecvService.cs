...
namespace Com.Alibaba.Sdk.Android.Push.Channel {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.alibaba.sdk.android.push.channel']/class[@name='TaobaoRecvService']"
	[global::Android.Runtime.Register ("com/alibaba/sdk/android/push/channel/TaobaoRecvService", DoNotGenerateAcw=true)]
	public partial class TaobaoRecvService : global::Android.App.Service {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/alibaba/sdk/android/push/channel/TaobaoRecvService", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (TaobaoRecvService); }
		}

		protected TaobaoRecvService (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.alibaba.sdk.android.push.channel']/class[@name='TaobaoRecvService']/constructor[@name='TaobaoRecvService' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe TaobaoRecvService ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (TaobaoRecvService)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Alibaba.Sdk.Android.Push.Channel.TaobaoRecvService __this = global::Java.Lang.Object.GetObject<global::Com.Alibaba.Sdk.Android.Push.Channel.TaobaoRecvService> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.alibaba.sdk.android.push.channel']/class[@name='TaobaoRecvService']/method[@name='onBind' and count(parameter)=1 and parameter[1][@type='android.content.Intent']]"
