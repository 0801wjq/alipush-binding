...
namespace Com.Taobao.Agoo {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.taobao.agoo']/class[@name='AgooCommondReceiver']"
	[global::Android.Runtime.Register ("com/taobao/agoo/AgooCommondReceiver", DoNotGenerateAcw=true)]
	public partial class AgooCommondReceiver : global::Android.Content.BroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/taobao/agoo/AgooCommondReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AgooCommondReceiver); }
		}

		protected AgooCommondReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.taobao.agoo']/class[@name='AgooCommondReceiver']/constructor[@name='AgooCommondReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AgooCommondReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (AgooCommondReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Taobao.Agoo.AgooCommondReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Taobao.Agoo.AgooCommondReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.taobao.agoo']/class[@name='AgooCommondReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
