...
namespace Com.Taobao.Accs.Internal {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.taobao.accs.internal']/class[@name='AccsJobService']"
	[global::Android.Runtime.Register ("com/taobao/accs/internal/AccsJobService", DoNotGenerateAcw=true)]
	public partial class AccsJobService : global::Android.App.Job.JobService {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/taobao/accs/internal/AccsJobService", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AccsJobService); }
		}

		protected AccsJobService (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.taobao.accs.internal']/class[@name='AccsJobService']/constructor[@name='AccsJobService' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AccsJobService ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (AccsJobService)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Taobao.Accs.Internal.AccsJobService __this = global::Java.Lang.Object.GetObject<global::Com.Taobao.Accs.Internal.AccsJobService> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.taobao.accs.internal']/class[@name='AccsJobService']/method[@name='onStartJob' and count(parameter)=1 and parameter[1][@type='android.app.job.JobParameters']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.taobao.accs.internal']/class[@name='AccsJobService']/method[@name='onStopJob' and count(parameter)=1 and parameter[1][@type='android.app.job.JobParameters']]"
