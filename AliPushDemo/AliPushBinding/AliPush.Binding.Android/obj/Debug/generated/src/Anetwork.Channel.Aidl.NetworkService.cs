...
namespace Anetwork.Channel.Aidl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='anetwork.channel.aidl']/class[@name='NetworkService']"
	[global::Android.Runtime.Register ("anetwork/channel/aidl/NetworkService", DoNotGenerateAcw=true)]
	public partial class NetworkService : global::Android.App.Service {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("anetwork/channel/aidl/NetworkService", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='anetwork.channel.aidl']/class[@name='NetworkService']/constructor[@name='NetworkService' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (NetworkService)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Anetwork.Channel.Aidl.NetworkService __this = global::Java.Lang.Object.GetObject<global::Anetwork.Channel.Aidl.NetworkService> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='anetwork.channel.aidl']/class[@name='NetworkService']/method[@name='onBind' and count(parameter)=1 and parameter[1][@type='android.content.Intent']]"
