...
namespace Com.TA.Utdid2.Device {
	...
	public partial class UTDevice : global::Java.Lang.Object {
		...
		static IntPtr id_getUtdidForUpdate_Landroid_content_Context_;
		...
		{
			if (id_getUtdidForUpdate_Landroid_content_Context_ == IntPtr.Zero)
				id_getUtdidForUpdate_Landroid_content_Context_ = JNIEnv.GetStaticMethodID (class_ref, "getUtdidForUpdate", "(Landroid/content/Context;)Ljava/lang/String;");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (context);
				string __ret = JNIEnv.GetString (JNIEnv.CallStaticObjectMethod  (class_ref, id_getUtdidForUpdate_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
