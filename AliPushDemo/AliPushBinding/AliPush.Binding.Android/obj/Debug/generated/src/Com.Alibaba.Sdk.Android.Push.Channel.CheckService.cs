...
namespace Com.Alibaba.Sdk.Android.Push.Channel {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.alibaba.sdk.android.push.channel']/class[@name='CheckService']"
	[global::Android.Runtime.Register ("com/alibaba/sdk/android/push/channel/CheckService", DoNotGenerateAcw=true)]
	public partial class CheckService : global::Android.App.Service {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/alibaba/sdk/android/push/channel/CheckService", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CheckService); }
		}

		protected CheckService (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.alibaba.sdk.android.push.channel']/class[@name='CheckService']/constructor[@name='CheckService' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe CheckService ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (CheckService)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Alibaba.Sdk.Android.Push.Channel.CheckService __this = global::Java.Lang.Object.GetObject<global::Com.Alibaba.Sdk.Android.Push.Channel.CheckService> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.alibaba.sdk.android.push.channel']/class[@name='CheckService']/method[@name='onBind' and count(parameter)=1 and parameter[1][@type='android.content.Intent']]"
