...
namespace Com.Taobao.Accs.Base {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.taobao.accs.base']/class[@name='BaseReceiver']"
	[global::Android.Runtime.Register ("com/taobao/accs/base/BaseReceiver", DoNotGenerateAcw=true)]
	public partial class BaseReceiver : global::Android.Content.BroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/taobao/accs/base/BaseReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BaseReceiver); }
		}

		protected BaseReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.taobao.accs.base']/class[@name='BaseReceiver']/constructor[@name='BaseReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe BaseReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (BaseReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Taobao.Accs.Base.BaseReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Taobao.Accs.Base.BaseReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.taobao.accs.base']/class[@name='BaseReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
