...
namespace Com.Xiaomi.Mipush.Sdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.xiaomi.mipush.sdk']/class[@name='PushServiceReceiver']"
	[global::Android.Runtime.Register ("com/xiaomi/mipush/sdk/PushServiceReceiver", DoNotGenerateAcw=true)]
	public partial class PushServiceReceiver : global::Android.Content.BroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/xiaomi/mipush/sdk/PushServiceReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (PushServiceReceiver); }
		}

		protected PushServiceReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.xiaomi.mipush.sdk']/class[@name='PushServiceReceiver']/constructor[@name='PushServiceReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PushServiceReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (PushServiceReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Xiaomi.Mipush.Sdk.PushServiceReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Xiaomi.Mipush.Sdk.PushServiceReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.xiaomi.mipush.sdk']/class[@name='PushServiceReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
