...
namespace Com.UT.Mini.Core.Sign {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ut.mini.core.sign']/class[@name='UTBaseRequestAuthentication']"
	[global::Android.Runtime.Register ("com/ut/mini/core/sign/UTBaseRequestAuthentication", DoNotGenerateAcw=true)]
	public partial class UTBaseRequestAuthentication : global::Java.Lang.Object, global::Com.UT.Mini.Core.Sign.IUTRequestAuthentication {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ut/mini/core/sign/UTBaseRequestAuthentication", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (UTBaseRequestAuthentication); }
		}

		protected UTBaseRequestAuthentication (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ut.mini.core.sign']/class[@name='UTBaseRequestAuthentication']/constructor[@name='UTBaseRequestAuthentication' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe UTBaseRequestAuthentication (string aAppkey, string aAppSecret)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (UTBaseRequestAuthentication)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ut.mini.core.sign']/class[@name='UTBaseRequestAuthentication']/constructor[@name='UTBaseRequestAuthentication' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='boolean']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Z)V", "")]
		public unsafe UTBaseRequestAuthentication (string aAppkey, string aAppSecret, bool isEncode)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.UT.Mini.Core.Sign.UTBaseRequestAuthentication __this = global::Java.Lang.Object.GetObject<global::Com.UT.Mini.Core.Sign.UTBaseRequestAuthentication> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string AppSecret {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ut.mini.core.sign']/class[@name='UTBaseRequestAuthentication']/method[@name='getAppSecret' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Appkey {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ut.mini.core.sign']/class[@name='UTBaseRequestAuthentication']/method[@name='getAppkey' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsEncode {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ut.mini.core.sign']/class[@name='UTBaseRequestAuthentication']/method[@name='isEncode' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ut.mini.core.sign']/class[@name='UTBaseRequestAuthentication']/method[@name='getSign' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
