...
namespace Com.Huawei.Android.Pushselfshow {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.huawei.android.pushselfshow']/class[@name='SelfShowReceiver']"
	[global::Android.Runtime.Register ("com/huawei/android/pushselfshow/SelfShowReceiver", DoNotGenerateAcw=true)]
	public partial class SelfShowReceiver : global::Java.Lang.Object {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/huawei/android/pushselfshow/SelfShowReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SelfShowReceiver); }
		}

		protected SelfShowReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.huawei.android.pushselfshow']/class[@name='SelfShowReceiver']/constructor[@name='SelfShowReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe SelfShowReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (SelfShowReceiver)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.android.pushselfshow']/class[@name='SelfShowReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
		...
		public virtual unsafe void OnReceive (global::Android.Content.Context p0, global::Android.Content.Intent p1)
		{
